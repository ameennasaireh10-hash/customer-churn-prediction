...
The goal is to identify customers likely to churn and compare different machine learning models based on their ability to detect the minority (churn) class.
